      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
            ...
            <div className="flex-shrink-0 flex items-center">
              ...
              >
                ...
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M334 667C150.641 667 2 518.359 2 335C2 151.641 150.641 3 334 3C517.359 3 666 151.641 666 335C666 518.359 517.359 667 334 667ZM334 591.114C475.448 591.114 590.114 476.448 590.114 335C590.114 193.552 475.448 78.8857 334 78.8857C192.552 78.8857 77.8857 193.552 77.8857 335C77.8857 476.448 192.552 591.114 334 591.114Z"
                  fill="#212D47"
                ></path>
              </svg>
          ...
          <div className="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8 ">
            ...
            <a
              href="#"
              className="border-gray-700 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
            >
              People
            </a>
              ...
              <div>
                ...
                >
                  ...
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=UYz71D7GgY&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                    alt=""
                  />
                </button>
              </div>
